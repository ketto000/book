...
//    public ResponseEntity<?>save(@RequestPart(value = "key") Book book, @RequestPart(value = "files",required = false)
//    List<MultipartFile> fileList) throws Exception {
//       return new ResponseEntity<>(bookService.저장하기(book,fileList),HttpStatus.CREATED);
//    }


    @PostMapping("/api/book")
    public ResponseEntity<?> insertMypageQna(
            @RequestPart(value = "key") Book book,
